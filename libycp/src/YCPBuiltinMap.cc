			  ...
			  const YCPMap &map, const YCPCode &expr)
{
     ...
     * The first item is the key of the new mapentry, the second is the value
     * of the new entry.
     *
     * Examples: <pre>
	...
	{
	    return YCPError ("Bad mapmap expression " + expr->toString ());
	}
	...
	{
	    return YCPError ("mapmap () expression has to deliver a list "
			     "with two entrys! You have produced this list "
			     + curr_list->toString ());
	}
    }
...
m_foreach (const YCPValue &key, const YCPValue &val, const YCPMap &map, const YCPCode &expr)
{
	...
	if (ret.isNull())
	{
	    return YCPError ("Bad foreach expression " + expr->toString ());
	}
	if (ret->isBreak())
	{
	    break;
...
YCPBuiltinMap::YCPBuiltinMap ()
{
	...
	{ "haskey", "b|Maa",    0,				(void *)m_haskey, 0 },
	{ "mapmap", "MA|YaYaMaCA",DECL_LOOP|DECL_SYMBOL,	(void *)m_mapmap, 0 },
	{ "maplist","La|YaYaMaCa",DECL_LOOP|DECL_SYMBOL,	(void *)m_maplist, 0 },
	{ "filter", "MA|YaYaMaCA",DECL_LOOP|DECL_SYMBOL,	(void *)m_filter, 0 },
	{ "union",  "Ma|MaMa",  0,				(void *)m_unionmap, 0 },
	{ "add",    "Ma|Maaa",  0,				(void *)m_addmap, 0 },
	{ "change", "Ma|Maaa",  0,				(void *)m_changemap, 0 },
	{ "size",   "i|Ma",     0,				(void *)m_size, 0 },
	{ "foreach","A|YaYaMaCA", DECL_SYMBOL,			(void *)m_foreach, 0},
	{ "tomap",  "MA|A",	0,				(void *)m_tomap, 0 },
	{ 0, 0, 0, 0 }
