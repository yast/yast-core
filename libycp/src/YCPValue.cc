...
YCPOrder YCPValueRep::compare(const YCPValue& v) const
{
	...
	case YT_STRING:      return this->asString()->compare(v->asString());
	...
	case YT_LOCALE:      return this->asLocale()->compare(v->asLocale());
