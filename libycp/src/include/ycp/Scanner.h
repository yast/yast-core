...
typedef struct formalparamstack {
    ...
    TypeCode type;			// type of formal parameter
...
public:
     ...
     * The value of the scanned token is saved in @erf #scanned_value and
...
private:
     ...
     * of a token.
     */
    void setScannedToken (tokenValue value, const TypeCode &type);
