...
\----------------------------------------------------------------------/
  ...
  File:	      YPkgRpmGroupTagsFilterView.cc
...
YPkgRpmGroupTagsFilterView::YPkgRpmGroupTagsFilterView()
    : YPkgTreeFilterView()
{
    addRpmGroupTags();
}
...
static const char *fallback_rpm_group_tags[] =
{
...
void
YPkgRpmGroupTagsFilterView::addRpmGroupTags()
{
    for ( unsigned i=0; i < DIM( fallback_rpm_group_tags ); i++ )
    {
	addBranch( fallback_rpm_group_tags[ i ], '/' );
    }
